        ...
        <div class="content" id="page-1">
            ...
            <ol>
                ...
                <li>Under Pages URL, enter a link you wish to create for this page.
                    <ul>
                        <li>Entering /about-us/ into this field, would generate a page such as: regard.co.uk/about-us/</li>
                        <li>If you wanted to add a page into the about-us hyperlink structure called 'the-regard-team', you would enter into the field: /about-us/the-regard-team/.  This would generate a page such as: regard.co.uk/about-us/the-regard-team/</li>
                        <li>
                            <div class="panel callout radius">
                                <h5>Note adding a URL such as /services/my-custom-service/, or /service-type/my-custom-service-type will not work.</h5>
                                <p>If you wish to create a new Service, you do so by navigating to Publish > and so on. Read the topic Heading Services and Services type.</p>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>Click Publish/Submit and continue reading to Navigation and Pages.</li>
            </ol>
        </div>
